...
layer, records immutable execution history, replays the log, verifies every
intermediate state hash, and shows deterministic failure cases.
...
- `validation/`: identity, sequence, duplicate, node, causal, and transition checks.
